...
home.addEventListener('click', () => {
    // yoyo and repeat together makes the shape return to its from attributes
...
notifications.addEventListener('click', () => {
    gsap.fromTo('.bell', { rotation: -5 }, { rotation: 0, duration: 2, ease: Elastic.easeOut.config(5, 0.2) });
    gsap.fromTo('.ringer', { rotation: -3, x: 0.5 }, { rotation: 0, x: 0, duration: 1, ease: Elastic.easeOut.config(5, 0.2) });
